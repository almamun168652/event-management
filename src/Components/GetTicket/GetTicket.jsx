        ...
        <div>
            <div>
                ...
                <div className="w-full md:w-3/4 px-4 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    ...
                    {/* single card */}
                    <div data-aos="fade-right" data-aos-duration="1000" className="text-center bg-white border shadow-xl p-4 rounded-lg space-y-5">
                    ...
                    <div data-aos="zoom-in" data-aos-duration="1000" className="text-center bg-white border shadow-xl p-4 rounded-lg space-y-5">
                    ...
                    <div data-aos="fade-left" data-aos-duration="1000" className="text-center bg-white border shadow-xl p-4 rounded-lg space-y-5">
